...
[String.prototype, Array.prototype].forEach(ele => {
...
function tempFunctionForPrivateVar(){
	...
	EventTarget.prototype.addEventListener = function(...args){
		if(dataArr[this.guydhtIndexInEventDataArr] == null){
			Object.defineProperty(this, "guydhtIndexInEventDataArr", {
				configurable: false,
				writable: false,
				enurable: false,
		...
		var index = dataArr[this.guydhtIndexInEventDataArr][type].findIndex((a, i, arr) => {
			return a[0].toString() == listener.toString() &&
				(a[1] != null && options != null ? 
					Object.keys(a[1]).every(ele => Object.keys(options).includes(ele)) &&
					Object.values(a[1]).every(ele => Object.values(options).includes(ele))
				: true);
		});
	...
	EventTarget.prototype.getEventListeners = function(ok){
		var obj = {};
		Object.assign(obj, dataArr[this.guydhtIndexInEventDataArr] || {});
		...
		if(ok)
			this.children.forEach(function needsAname(element){
				...
				var indexToRemove = Object.keys(tempObj).indexOf("target");
				Object.keys(tempObj).filter((ele, i) => i != indexToRemove).forEach((ele, i) => {
					if(obj[ele] == null)
						obj[ele] = [];
					obj[ele].push(...Object.values(tempObj).filter((ele, i) => {return i != indexToRemove})[i]);
				});
			});
		return obj;
	};
...
Object.defineProperty(Node.prototype, "ancestors", {
	get(){
...
var selector = document.querySelector.bind(document),
	...
	eSelector = Element.prototype.querySelector,
	eSelectorAll = Element.prototype.querySelectorAll;
Element.prototype.querySelectorAll = function(...text){return helper(text, eSelectorAll.bind(this));};
Element.prototype.querySelector = function(text){try{return eSelector.call(this, text);}catch(e){return helper([text], eSelector.bind(this));}};
...
defineProperty(String.prototype, "decodeEscapeSequence", {
	value: function() {
...
defineProperty(Array.prototype, "equals", {
	value: function(arr){
...
defineProperty(Object.prototype, 'values', {
	value: function(){
		return Object.values(this);
	}
});
['values', 'keys', 'entries'].forEach(prop => {
	defineProperty(Object.prototype, prop, {
		value: function(){
...
defineProperty(String.prototype, "trunct", {
...
defineProperty(Element.prototype, "styleAdd", {
	set(styleToAdd){
...
(function pseudoStyle(){
	...
	["hover", "after", "before", "active"].forEach(function(pe){
		defineProperty(Element.prototype, "style" + pe.capital(), {
			set(ruleText){
...
defineProperty(HTMLSelectElement.prototype, "getSelected", {
	value: function(){
		return this.options[this.selectedIndex];
	}
});
defineProperty(String.prototype, "substringIndexOf", {
...
defineProperty(String.prototype, "substringLastIndexOf", {
	value: function(text, offset, maybeOffset){
...
defineProperty(Node.prototype, "text", {
	get: function(){
...
Object.getOwnPropertyNames(Node.prototype).concat(arrayToMove).concat(Object.getOwnPropertyNames(HTMLElement.prototype)).concat(Object.getOwnPropertyNames(Element.prototype)).filter(function(ele, i, arr){return arr.indexOf(ele) == i;}).forEach(function(Ele, i){
	if(NodeList.prototype[Ele] != null || "classList" == Ele || Ele == "style") return;
	if(typeof document.createElement("asd")[Ele] == "function")
		defineProperty(NodeList.prototype, Ele, {
			value: function(...args){
...
defineProperty(Element.prototype, "getSelector", {
	value: function(){
		var id = "#" + (this.id || ""),
			element = this,
			path = [];
...
defineProperty(NodeList.prototype, "where", {
...
Object.getOwnPropertyNames(Array.prototype).filter(function(ele, i, arr){return arr.indexOf(ele) == i;}).forEach(function(Ele){
	if(Ele == "length" || NodeList.prototype[Ele] != null) return;
	defineProperty(NodeList.prototype, Ele, {
		value: function(){
			var arr = [...this];
...
defineProperty(NodeList.prototype, "visible", {
	value: function(){
		var arr = [];
		this.forEach(function(ele){
...
defineProperty(Element.prototype, "visible", {
	get: function(){
...
defineProperty(Object.prototype, "filter", {
	value: function(func){
		if(typeof func != "function") return null;
		var names = Object.getOwnPropertyNames(this).filter(ele => func(this[ele], ele, this)),
			obj = {};
		names.forEach(ele => obj[ele] = this[ele]);
		return obj
	}
});
defineProperty(Object.prototype, "toArr", {
	value: function(){
		try{
...
defineProperty(HTMLCollection.prototype, "forEach", {
	value: function(...args){
...
defineProperty(DOMRect.prototype, "toObj", {
	value: function(){
